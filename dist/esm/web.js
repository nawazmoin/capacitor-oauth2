        ...
        return new Promise((resolve, reject) => {
            ...
            if (!this.webOptions.appId || this.webOptions.appId.length == 0) {
                ...
                this.intervalId = window.setInterval(() => {
                    ...
                    else if (((_a = this.windowHandle) === null || _a === void 0 ? void 0 : _a.closed) &&
                        ...
                        if (href != null &&
                            ...
                            if (authorizationRedirectUrlParamObj) {
                                ...
                                if (authorizationRedirectUrlParamObj.state ===
                                    ...
                                    if (this.webOptions.accessTokenEndpoint) {
                                        ...
                                        if (authorizationCode) {
                                            ...
                                            tokenRequest.onerror = function () {
                                                ...
                                                self.doLog("ERR_GENERAL: See client logs. It might be CORS. Status text: " +
                                                    this.statusText);
                                                reject(new Error("ERR_GENERAL"));
                                            };
                                            tokenRequest.open("POST", this.webOptions
                                            ...
                                            if (this.webOptions
                                                ...
                                                for (const key in this
                                                    .webOptions
                                                    .additionalResourceHeaders) {
                                                    tokenRequest.setRequestHeader(key, this.webOptions
                                                        .additionalResourceHeaders[key]);
                                                }
                                            }
                                    ...
                                    if (this.webOptions.logsEnabled) {
                                        this.doLog("State from web options: " +
                                            this.webOptions.state);
